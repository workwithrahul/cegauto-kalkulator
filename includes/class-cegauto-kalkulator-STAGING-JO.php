...
class CegautoKalkulator {
  ...
  public function send_data_to_minicrm() {
    ...
    $contact_url  = "https://22366:Dd6J0heVtSmTF1p7xIOyGsXMiCnUBPZj@r3-test.minicrm.hu/Api/R3/Contact";
    ...
    $Params = array(
      ...
      "Telefonszam3"=>@$_POST['data']['mssys_phone'],
      "StatusId"=>2664,
      'BruttoVetelar4'=> (int)@$_POST['data']['brutto_vetelar'],
      'Onero4'=>(int)@$_POST['data']['onero'],
      'Futamido4'=>@$_POST['data']['futamido'],
      'Futasteljesitmeny4'=>@$_POST['data']['futasteljesitmeny'],
      'Motorteljesitmeny2'=>(int)@$_POST['data']['motor_teljesitmeny'],
      'Uzemanyag4'=>$uzemanyag,
     // 'GepjarmuJellege4'=>@$_POST['data']['gepjarmu_jellege'],
      // 'KalkulaltHavidij3'=>(int)str_replace('Ft','', @$_POST['data']['kalkulalt_onero']),
      'GepjarmuJellege4'=>$gepjarmujellege,
	  'KalkulaltOnero4'=>(int)$kalkulaltOnero,
      'KalkulaltHavidij3'=>(int)$kalkulaltHavidij,
      'Cegnev4' => @$_POST['data']['mssys_company'],
      'AjanlatForrasa' =>2386,
      'Rendelkezike1LezartEvvel2' => ($_POST['data']['min1lezart_ev'] == "igen") ? "2132" : "2133",
      'KerVisszahivast4' => ($_POST['data']['ker_visszahivast'] == "igen") ? "2300" : "2301",
      'Gyartmany' => @$_POST['data']['milyen_gyartmany_erdekli'],
      'KeszletesAuto'=>($_POST['data']['keszletes_auto_erdekel'] == "true") ? "2339" : "2340",
      'FeliratkozomHirlevelre2'=>($_POST['data']['feliratkozom_hirlevelre'] == "true") ? "1" : "0",
      'Adatkezeles'=>($_POST['data']['elfogadom_az_adatkezelesi_szabalyzatot'] == "true") ? "2347" : "2348",
      'Deleted' => "0",
      'VanLezartEv2'=>"2296",
    //  'AjanlatBeerkezese'=>date('Y . m.d H:i'),
	  'AjanlatBeerkezese'=>date('Y . m.d H:i', strtotime('1 hour')),
      'Hirlevel3'=>($_POST['data']['feliratkozom_hirlevelre'] == "true") ? "2343" : "2344",
      'UserId'=>24105
    );
